...
def plot_results(name, times: np.ndarray, positions: np.ndarray, velocities: np.ndarray, torque: np.ndarray, error: np.ndarray):
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('logs/plots/' + name + '_pos.png')
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('logs/plots/' + name + '_vel.png')
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('logs/plots/' + name + '_tor.png')
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    plt.savefig('logs/plots/' + name + '_err.png')
    plt.close()
